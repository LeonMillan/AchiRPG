...
const { PluginManager, Scene_Boot } = window;

const { bannerImg } = PluginManager.parameters("ArchiRPG_Connect");
...
function makeConnectForm(): HTMLElement {
    ...
    `;
    const form = container.querySelector<HTMLDivElement>('#archi-connect-form')!;
    ...
    const urlInput = container.querySelector<HTMLInputElement>('#archi-connect-url-input')!;
    const passwordInput = container.querySelector<HTMLInputElement>('#archi-connect-password-input')!;
